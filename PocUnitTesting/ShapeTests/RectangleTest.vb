...
Namespace PocUnitTesting
    ...
    Public Class RectangleTest
        ...
        Sub TestZeroRectangle()
            Dim circle As IShape = New Rectangle(0, 0)
        ...
        Sub TestBothPositiveValues()
            ...
            Dim rectangle As IShape = New Rectangle(positiveValue, positiveValue)
        ...
        Sub TestBothNegativeValues()
            ...
            Dim rectangle As IShape = New Rectangle(negativeInteger, negativeInteger)
        ...
        Sub TestNegativeAndPositiveValues()
            ...
            Dim rectangle As IShape = New Rectangle(negativeInteger, positiveInteger)
        ...
        Sub TestMaxInteger()
            ...
            Dim rectangle As IShape = New Rectangle(maxInteger, maxInteger)
        ...
        Sub TestMinInteger()
            ...
            Dim rectangle As IShape = New Rectangle(minInteger, minInteger)
